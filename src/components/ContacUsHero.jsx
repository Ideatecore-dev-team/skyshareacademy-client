      ...
      <div className="contact-section bg-orange-bg bg-cover flex flex-col sm:content-end items-center gap-gap10 lg:pt-padding170 pt-padding106 pb-14 px-6 lg:py-24">
        <div className="inside-padding flex flex-col w-312 lg:w-nav content-end items-center gap-gap10 lg:gap-6">
          <div className="contact-container flex flex-col items-center lg:gap-6 lg:flex-wrap gap-4 self-stretch">
            <h1 className="headline-1 text-center text-neutral-2 self-stretch">
              Punya Pertanyaan Lebih <br className=" xs:hidden" /> Lanjut?
            </h1>
            <p className="paragraph text-center self-stretch text-neutral-2">
              Layanan kami tersedia Senin-Minggu, {/* add break line */} <br />{" "}
              jam <span className=" font-bold"> 08.00-20.00</span>
            </p>
            <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 relative">
              <div className="button-wa w-312 h-auto">
                <a
                  href="https://wa.me/62895413928653"
                  className="contact-buttons-white flex flex-col items-center gap-gap7277 relative overflow-hidden transition-all duration-300 ease-in-out hover:translate-x-1 hover:translate-y-1 active:translate-x-2 active:translate-y-2"
                >
                  <svg
                    className="svgAUAH"
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M71.1732 54.0734L44.8858 42.8291L55.5155 16.2878L28.9995 26.9226L17.74 0.650391L6.47543 26.9226L-20.0406 16.2878L-9.4108 42.8291L-35.6982 54.0734L-9.4108 65.3177L-20.0406 91.8591L6.47543 81.2242L17.74 107.496L28.9995 81.2242L55.5155 91.8591L44.8858 65.3177L71.1732 54.0734Z"
                      fill="#FFD9AC"
                    />
                  </svg>
                  <div className="wa-and-logo flex items-center gap-gap7277">
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M18.9707 12.2842L3.05255 12.2842L3.05255 10.9197L18.9707 10.9197L18.9707 12.2842Z"
                        fill="#334151"
                      />
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M18.2887 10.9194C15.08 10.9194 12.458 13.7412 12.458 16.7501L12.458 17.4324L13.8224 17.4324L13.8224 16.7501C13.8224 14.4656 15.8624 12.2839 18.2887 12.2839L18.9709 12.2839L18.9709 10.9194L18.2887 10.9194Z"
                        fill="#334151"
                      />
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M18.2887 12.2842C15.08 12.2842 12.458 9.46241 12.458 6.45347L12.458 5.77125L13.8224 5.77125L13.8224 6.45347C13.8224 8.73805 15.8624 10.9197 18.2887 10.9197L18.9709 10.9197L18.9709 12.2842L18.2887 12.2842Z"
                        fill="#334151"
                      />
                    </svg>
                  </div>
                  <p className=" paragraph text-neutral-2 text-center">
                    (+62) 8954-1392-8653
                  </p>
                </a>
              </div>
              <div className="button-email w-312 h-auto">
                <button
                  className="contact-buttons-white flex flex-col items-center gap-gap7277 relative overflow-hidden transition-all duration-300 ease-in-out hover:translate-x-1 hover:translate-y-1 active:translate-x-2 active:translate-y-2"
                  onClick={() => window.open("mailto:msimbusiness@org.com", "_blank")}
                >
                  <svg
                    className="svgAUAH"
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="wa-and-logo flex items-center gap-gap7277">
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M5.68273 7.28223L11.0251 11.6235L16.3675 7.28223L17.228 8.34113L11.0251 13.3816L4.82227 8.34113L5.68273 7.28223Z"
                        fill="#001125"
                      />
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M1.21094 2.23779H20.7678V19.9754H1.21094V2.23779ZM2.57537 3.60222V18.611H19.4034V3.60222H2.57537Z"
                        fill="#001125"
                      />
                    </svg>
                    <h3 className="headline-3 text-neutral-2 text-center">
