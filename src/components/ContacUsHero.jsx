          ...
          <div className="contact-container flex flex-col items-center lg:gap-6 lg:flex-wrap gap-4 self-stretch">
            ...
            <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 relative">
              <div className="test w-312 h-auto">
                <a href="https://wa.me/62895413928653" className="contact-buttons-white flex flex-col items-center gap-gap7277 relative overflow-hidden">
                  ...
                  <p className=" paragraph text-neutral-2 text-center">(+62) 8954-1392-8653</p>
                </a>
              </div>
              <div className="test w-312 h-auto">
