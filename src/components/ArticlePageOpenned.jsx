      ...
      <div className="hero flex background flex-col items-center self-stretch">
        <div className="content h-full pb-20 lg:mt-10">
          ...
          <div>
            {article.image_heading && (
              <img
                ...
                className="mt-4 mx-auto lg:size-[30%]"
              />
            )}
          ...
          />
              ...
              <div className="kategori lg:block hidden">
                <p className="paragraph pl-10 text-right pr-2">Category:</p>
                <h4
                  style={{ backgroundColor: `${article.category_color}` }}
                  className={`text-white flex justify-center items-center font-bold px-2 py-1 w-auto rounded-full`}
                >
                  {article.category_name}
                </h4>
              </div>
